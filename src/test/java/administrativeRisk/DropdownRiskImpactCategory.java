...
public class DropdownRiskImpactCategory extends BaseClass {
	@Test
	public void riskImpactDropdownInAdministrativeRisk() {
		...
		js.executeScript("arguments[0].scrollIntoView(true)", basePg.getRiskImpactCategoryLabel());
		...
		data.checkDropDownListfromUIAndExcel(driver, "Risk Impact Category","Administrative");
	}
