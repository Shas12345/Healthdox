...
public class DropdownSubControlNameIfManagementRadioButtonAndSystemAndServicesAcquisitionOptionSelected
		extends BaseClass {
	@Test
	public void dropdownSubControlNameIfManagementRadioButtonAndSystemAndServicesAcquisitionOptionSelected() {
		...
		// selecting System and Services Acquisition option
		driver.findElement(By.xpath("//li[contains(text(),'System and Services Acquisition')]")).click();
		basePg.getSubControlNameDropdown().click();
		data.checkDropDownListfromUIAndExcel(driver, "Management System and Services Acquisition Sub Control Name",
				"Administrative");
	}
