...
public class DropdownSubControlNameIfTechnicalRadioButtonAndAuditAndAccountabilityOptionSelected extends BaseClass {
	@Test
	public void dropdownSubControlNameIfTechnicalRadioButtonAndAuditAndAccountabilityOptionSelected() {
		...
		Reporter.log("Successfully clicked on Risk Assessment on left navigation bar in Administrative risks page",
				true);
		...
		// selecting Audit and Accountability option
		driver.findElement(By.xpath("//li[text()='Audit and Accountability']")).click();
		basePg.getSubControlNameDropdown().click();
		data.checkDropDownListfromUIAndExcel(driver, "Technical Audit and Accountability Sub Control Name",
				"Administrative");
	}
