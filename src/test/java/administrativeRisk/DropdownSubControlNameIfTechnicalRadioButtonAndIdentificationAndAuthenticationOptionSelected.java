...
public class DropdownSubControlNameIfTechnicalRadioButtonAndIdentificationAndAuthenticationOptionSelected  extends BaseClass{
	@Test
	public void	dropdownSubControlNameIfTechnicalRadioButtonAndIdentificationAndAuthenticationOptionSelected() {
		...
		data.checkDropDownListfromUIAndExcel(driver, "Technical Identification and Authentication Sub Control Name","Administrative");
	}
