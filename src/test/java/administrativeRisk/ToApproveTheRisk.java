...
public class ToApproveTheRisk extends BaseClass {
	...
	public void toApproveAdministrativeRiskAssessment(String info[]) throws InterruptedException {
		...
		// explicit.until(ExpectedConditions.elementToBeClickable(adminPg.getSaveAndForwardApprovalButton()));
		driver.findElement(By.id("SaveAndApprovalARiskAssessBtn")).click();
		...
		riskReviewPg.getAdministrativeRisks().click();
