...
public class DropdownSubControlNameIfManagementRadioButtonAndRiskAssessmentOptionSelected
		extends BaseClass {
	@Test
	public void dropdownSubControlNameIfManagementRadioButtonAndRiskAssessmentOptionSelected() {
		...
		// selecting Risk Assessment option
		driver.findElement(By.xpath("//li[contains(text(),'Risk Assessment')]")).click();
		basePg.getSubControlNameDropdown().click();
		data.checkDropDownListfromUIAndExcel(driver, "Management Risk Assessment Sub Control Name",
				"Physical");
	}
