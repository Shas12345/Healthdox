...
public class DropdownSubControlNameIfOperationalRadioButtonAndAwarenessAndTrainingOptionSelected extends BaseClass {
	@Test
	public void dropdownSubControlNameIfOperationalRadioButtonAndAwarenessAndTrainingOptionSelected() {
		...
		// selecting Awareness and Training option
		driver.findElement(By.xpath("//li[contains(text(),'Awareness and Training')]")).click();
		basePg.getSubControlNameDropdown().click();
		data.checkDropDownListfromUIAndExcel(driver, "Operational Awareness and Training Sub Control Name",
				"Physical");
	}
