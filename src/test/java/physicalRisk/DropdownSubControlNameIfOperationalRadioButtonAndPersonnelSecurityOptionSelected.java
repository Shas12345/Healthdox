...
public class DropdownSubControlNameIfOperationalRadioButtonAndPersonnelSecurityOptionSelected extends BaseClass {
	@Test
	public void dropdownSubControlNameIfOperationalRadioButtonAndPersonnelSecurityOptionSelected() {
		...
		// selecting Personnel Security option
		driver.findElement(By.xpath("//li[contains(text(),'Personnel Security')]")).click();
		basePg.getSubControlNameDropdown().click();
		data.checkDropDownListfromUIAndExcel(driver, "Operational Personnel Security Sub Control Name",
				"Physical");
	}
