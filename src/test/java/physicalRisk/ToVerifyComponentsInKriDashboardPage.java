...
public class ToVerifyComponentsInKriDashboardPage extends BaseClass {
	...
	public void toVerifyComponentsInKriDashboardPage() {
		...
		softassert.assertEquals(pageText,data.fromPropertyFile("dashBoardTitleInPhysical"),
		...
		explicit.until(ExpectedConditions.visibilityOfAllElements(headerTitle));
		...
		try {
			...
			Reporter.log("1st Graph Data" + driver.findElement(By.xpath("(//*[local-name()='svg'])[1]")).getText(),true);
		} catch (Exception e) {
		...
		try {
			...
			Reporter.log("2nd Graph Data " + driver.findElement(By.xpath("(//*[local-name()='svg'])[2]")).getText(),true);
		} catch (Exception e) {
			driver.navigate().refresh();
			extentTest.info("2nd Graph Data " + driver.findElement(By.xpath("(//*[local-name()='svg'])[2]")).getText());
			Reporter.log("2nd Graph Data " + driver.findElement(By.xpath("(//*[local-name()='svg'])[2]")).getText(),true);
		...
		try {
			...
			Reporter.log("3rd Graph Data " + driver.findElement(By.xpath("(//*[local-name()='svg'])[3]")).getText(),true);
		} catch (Exception e) {
			driver.navigate().refresh();
			extentTest.info("3rd Graph Data" + driver.findElement(By.xpath("(//*[local-name()='svg'])[3]")).getText());
			Reporter.log("3rd Graph Data " + driver.findElement(By.xpath("(//*[local-name()='svg'])[3]")).getText(),true);
		...
		try {
			...
			Reporter.log("4th Graph Data " + driver.findElement(By.xpath("(//*[local-name()='svg'])[4]")).getText(),true);
		} catch (Exception e) {
			driver.navigate().refresh();
			extentTest.info("4th Graph Data" + driver.findElement(By.xpath("(//*[local-name()='svg'])[4]")).getText());
			Reporter.log("4th Graph Data " + driver.findElement(By.xpath("(//*[local-name()='svg'])[4]")).getText(),true);
		...
		try {
			...
			Reporter.log("5th Graph Data " + driver.findElement(By.xpath("(//*[local-name()='svg'])[5]")).getText(),true);
		} catch (Exception e) {
			driver.navigate().refresh();
			extentTest.info("5th Graph Data" + driver.findElement(By.xpath("(//*[local-name()='svg'])[5]")).getText());
			Reporter.log("5th Graph Data " + driver.findElement(By.xpath("(//*[local-name()='svg'])[5]")).getText(),true);
		...
		try {
			...
			Reporter.log("6th Graph Data " + driver.findElement(By.xpath("(//*[local-name()='svg'])[6]")).getText(),true);
		} catch (Exception e) {
			driver.navigate().refresh();
			extentTest.info("6th Graph Data" + driver.findElement(By.xpath("(//*[local-name()='svg'])[6]")).getText());
			Reporter.log("6th Graph Data " + driver.findElement(By.xpath("(//*[local-name()='svg'])[6]")).getText(),true);
