...
public class ToVerifyLeftNavigationBarFunctionality extends BaseClass {
	...
	@Test
	public void PhysicalRiskNavBar() {
		hrmPg.getPraImage().click();
		softassert.assertEquals(basePg.getKriDashboardLeftNavBar().isDisplayed(), true,
				"KRI Dashboard section is not provided in left navigation bar for Physical Risk Assessment");
		Reporter.log("Verifyed KRI Dashboard section in left navigation bar for Physical Risk Assessment", true);
		extentTest.info("Verifyed KRI Dashboard section in left navigation bar for Physical Risk Assessment");

		softassert.assertEquals(basePg.getRiskAssessmentLeftNavBar().isDisplayed(), true,
				"Risk Assessment is not provided in left navigation bar for Physical Risk Assessment");
		...
		softassert.assertEquals(basePg.getNewRisk().isDisplayed(), true,
				"New Risk option is not provided in left navigation bar for Physical Risk Assessment");
		basePg.getNewRisk().click();
		explicit.until(ExpectedConditions.visibilityOf(basePg.getRiskAssessmentTable()));
		Reporter.log(
				"Successfully verifyed on clicking New risk in left navigation bar navigated to New Physical Risk Assessment Page",
				true);
		extentTest.info(
				"Successfully verifyed on clicking New risk in left navigation bar navigated to New Physical Risk Assessment Page");
		basePg.getRiskAssessmentLeftNavBar().click();
		...
		softassert.assertEquals(basePg.getEditRisk().isDisplayed(), true,
				"Edit Risk option is not provided in left navigation bar for Physical Risk Assessment");
		basePg.getEditRisk().click();
		explicit.until(ExpectedConditions.visibilityOf(adminPg.getListHeader()));
		Reporter.log(
				"Successfully verifyed on clicking Edit risk in left navigation bar navigated to Edit Physical Risk Assessment Page",
				true);
		extentTest.info(
				"Successfully verifyed on clicking Edit risk in left navigation bar navigated to Edit Physical Risk Assessment Page");
		basePg.getRiskAssessmentLeftNavBar().click();
		...
		softassert.assertEquals(basePg.getViewRisk().isDisplayed(), true,
				"View Risk option is not provided in left navigation bar for Physical Risk Assessment");
		...
		softassert.assertEquals(basePg.getAllRisk().isDisplayed(), true,
				"All Risk option is not provided in left navigation bar for Physical Risk Assessment");
		basePg.getAllRisk().click();
		explicit.until(ExpectedConditions.visibilityOf(adminPg.getListHeader()));
		Reporter.log(
				"Successfully verifyed on clicking All risk in left navigation bar navigated to All Physical Risk Assessment Page",
				true);
		extentTest.info(
				"Successfully verifyed on clicking All risk in left navigation bar navigated to All Physical Risk Assessment Page");
		...
		softassert.assertEquals(basePg.getOpenRisk().isDisplayed(), true,
				"Open Risk option is not provided in left navigation bar for Physical Risk Assessment");
		basePg.getOpenRisk().click();
		explicit.until(ExpectedConditions.visibilityOf(adminPg.getListHeader()));
		Reporter.log(
				"Successfully verifyed on clicking Open risk in left navigation bar navigated to All Physical Risk Assessment Page",
				true);
		extentTest.info(
				"Successfully verifyed on clicking Open risk in left navigation bar navigated to All Physical Risk Assessment Page");
		...
		softassert.assertEquals(basePg.getInProgressRisk().isDisplayed(), true,
				"In Progress Risk option is not provided in left navigation bar for Physical Risk Assessment");
		basePg.getInProgressRisk().click();
		explicit.until(ExpectedConditions.visibilityOf(adminPg.getListHeader()));
		Reporter.log(
				"Successfully verifyed on clicking In Progress risk in left navigation bar navigated to All Physical Risk Assessment Page",
				true);
		extentTest.info(
				"Successfully verifyed on clicking In Progress risk in left navigation bar navigated to All Physical Risk Assessment Page");
		...
		softassert.assertEquals(basePg.getClosedRisk().isDisplayed(), true,
				"Closed Risk option is not provided in left navigation bar for Physical Risk Assessment");
		basePg.getClosedRisk().click();
		explicit.until(ExpectedConditions.visibilityOf(adminPg.getListHeader()));
		Reporter.log(
				"Successfully verifyed on clicking Closed risk in left navigation bar navigated to All Physical Risk Assessment Page",
				true);
		extentTest.info(
				"Successfully verifyed on clicking Closed risk in left navigation bar navigated to All Physical Risk Assessment Page");
		// Verifying and clicking on Reports
		softassert.assertEquals(basePg.getReports().isDisplayed(), true,
				"Reports section is not provided in left navigation bar for Physical Risk Assessment");
		...
		softassert.assertEquals(basePg.getRiskExcelReports().isDisplayed(), true,
				"Risk Excel Reports option is not provided under Reports section in left navigation bar for Physical Risk Assessment");
		...
		softassert.assertEquals(basePg.getRiskPdfReports().isDisplayed(), true,
				"Risk PDF Reports option is not provided under Reports section in left navigation bar for Physical Risk Assessment");
		...
		softassert.assertEquals(basePg.getKrisInPdf().isDisplayed(), true,
				"KRI PDF Reports option is not provided under Reports section in left navigation bar for Physical Risk Assessment");
		...
		softassert.assertEquals(basePg.getSystemConfiguration().isDisplayed(), true,
				"System Configuration section is not provided in left navigation bar for Physical Risk Assessment");
		...
		softassert.assertEquals(basePg.getUpdateSelfRiskAssessmentQuestions().isDisplayed(), true,
				"Update Self Risk Assessment Questions option is not provided under System Configuration section in left navigation bar for Physical Risk Assessment");
		...
		softassert.assertEquals(basePg.getCollapseIcon().isDisplayed(), true,
				"Collapse icon is not provided under System Configuration section in left navigation bar for Physical Risk Assessment");
