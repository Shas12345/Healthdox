...
public class DropdownSubControlNameIfOperationalRadioButtonAndContingencyPlaningOptionSelected extends BaseClass {
	@Test
	public void dropdownSubControlNameIfOperationalRadioButtonAndContingencyPlaningOptionSelected() {
		...
		// selecting Contingency Planing option
		driver.findElement(By.xpath("//li[contains(text(),'Contingency Planing')]")).click();
		basePg.getSubControlNameDropdown().click();
		data.checkDropDownListfromUIAndExcel(driver, "Operational Contingency Planing Sub Control Name",
				"Technology");
